    ...
    <script>
        $(document).ready(function() {
            $(".remove_link").click(function() {
                ...
                var aff_id = getParameterByName('sub1');
                var click_id = getParameterByName('sub2');
                //alert(click_id);return false;
            ...
            <div class="modal-content">
                <div class="modal-body" style="padding-left:25px;padding-right:25px; padding-bottom:25px;">
                    ...
                    <br>Disponible pour les <strong><span style="color:red;">
                            <font color="red">
                                <div id="timebox" class="timebox" style="display: inline-block;">1:15 minutes</div>
                            </font>
                        </span></strong><span>à venir</span><br><br>
                    ...
                    <p></p><!-- Audio -->
                    <button id="modalbutton" style="background:#CD1E25 !important; ;color: #FFFFff;" type="button"
            ...
            <div class="row reviewboxbuttons">
                <div class="col-sm-12">
                    ...
                    <div id="2" style="display:none">
                        ...
                        <div class="question center_q">Êtes-vous satisfait par Free?</div>
                    ...
                    <div id="3" style="display:none">
                        ...
                        <div class="question center_q">Que préférez-vous chez Free?</div>
                    ...
                    <div id="4" style="display:none">
                        ...
                        <div class="question center_q">Avez-vous déjà dû appeler l'assistance technique du Free raison
                            d'un problème ?</div>
                    ...
                    <div id="5" style="display:none">
                        ...
                        <div class="question center_q">Comment évaluez-vous votre connexion Free (y compris la
                    ...
                    <div id="6" style="display:none">
                        ...
                        <div class="question center_q">Êtes-vous déjà resté(e) chez Free pendant plus de 6 mois ?</div>
                    ...
                    <div id="7" style="display:none">
                        ...
                        <div class="question center_q">A quel degré recommanderiez-vous Free à un ami ?</div>
                    ...
                    <div id="8" style="display:none">
                        ...
                        <div class="question center_q">D'après votre connaissance des services Free, est-il mieux,
                    ...
                    <div id="loading-img" style="display:none">
                        <p><b>C'est bon, vous avez fini ! </b></p>
                        <p>Envoi de réponses ...</p>
                    ...
                    <div id="results" style="display:none">
                        ...
                        <div id="offers">
                            <div class="row row-parent" id="owallwrapper">
                                <!-- PHP START -->
                                <?php 
                                     $products = mysqli_query($conn,"SELECT * FROM products order by sort_order asc") or die( mysqli_error($conn));
                                        if($products){
                                    ...
                                    <div class="row offer-row"
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                ...
                                                target="_blank"><img id="offer_img_2" class="img-responsive"
                                                    style="max-width: 130px; margin: 0 auto;" src="<?php echo $row['images'];?>"
                                                    alt="..." onclick="ViewOffer_2();"></a>
                                            <div class="reviewitem" style="color:#164d96;"><img id="star_img_2"
                                                    src="<?php echo $row['reviews'];?>" height="18" width="71"
                                                    onclick="ViewOffer_2();"> <a id="offer_review_anchor_2"
                                                    onclick="ViewOffer_2();">(<?php echo $row['review_users'];?>)</a></div> <br>
                                        ...
                                        <div class="col-md-5 text-center" style="color: black;"> <br> <strong>
                                            ...
                                            </strong><br><b><?php echo $row['description'];?> </b> <br>
                                            Prix normal: <strike><?php echo $row['product_price'];?>€</strike> <br> Prix d'aujourd'hui: <font
                                                color="#008000"><strong style="background-color: yellow;"><?php echo $row['regular_price'];?>€</strong>
                                            </font><br> Ne payez que les frais d'expédition:
                                            <strong><?php echo $row['shipping'];?>€</strong><br>Quantité disponible: (<font color="#FF0000"><?php echo $row['quantity'];?>
                                            </font>)<br> <br> <span class=" quantity"> <span
                                                    class="label label-danger">1</span> </span>
                                        </div>
                                        <div id="claim_btn_div_2" class="col-md-4 height:100%;"> 
                                        <?php 
                                        if($row['img_popular'])
                                        {
                                        ?>
                                        <img src="<?php echo $row['img_popular'];?>" width="100px">
                                        <?php
                                        }
                                        ?>
                                        <a id="<?php echo $row['url_1'];?>"
                                                class="remove_link"
                                                target="_blank"><button id="claim_btn_2" onclick="ViewOffer_2();"
                                                    style="cursor:pointer;font-size: 1.2em; color: black; margin:auto auto; width:100%; max-height:40px;background:#CD1E25;color:#ffffff ;"
                                                    class="text-center btn-lg click_claim_btn">Cliquez içi →</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="list-group">
                            <li class="media list-group-item2">
                                ...
                                <div class="media-body">
                                    <p class="media-heading comment-name">Guillaume Dubois- Delhi<span
                                            class="comment-time">
                                            <script>
                                            r_comment_date(1);
                            ...
                            <li class="media list-group-item2">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="comment-body">Je viens d’appeler le transporteur. Il m’a dit qu’il
                                        m’apporterait le colis aujourd’hui. Mais quand même, j’attends d’avoir l’iPhone
                                        entre les mains pour y croire vraiment :)</p>
                                </div>
                            </li>
                                    ...
                                    -->
                                            ...
                                            <div class="col-md-6">
                                                <button id="commentbutton"
                                                    style="font-size: 1.2em; color: black; margin:auto auto; width:100%; max-height:40px;background:#CD1E25; color: #ffffff;"
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <div class="review">
                            ...
                            <span class="user_info">BY MARIE ROUSSEAU-DELHI, LOURDES</span>
                    ...
                    <div class="col-sm-6">
                        <div class="review">
                            <img src="images/big_4_half_star.png">
                            <div class="rate4 review_title">J'ai reçu ma carte-cadeau dans les...</div>
